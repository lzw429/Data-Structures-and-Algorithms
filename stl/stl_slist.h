...
__slist_make_link(_Slist_node_base *__prev_node,
                  _Slist_node_base *__new_node) {//创建新结点
...
__slist_previous(_Slist_node_base *__head,
    ...
    while (__head && __head->_M_next != __node)//遍历链表，找到__node前一个结点
...
__slist_previous(const _Slist_node_base *__head,
                 const _Slist_node_base *__node) {//遍历链表，找到__node前一个结点
...
inline _Slist_node_base *__slist_reverse(_Slist_node_base *__node) {//返回__node
